    ...
    return (
        <div className="space-y-3" style={{ fontFamily: 'Inter, -apple-system, BlinkMacSystemFont, sans-serif' }}>
            ...
            <div className="bg-[#252525] rounded-lg p-3">
                <span className="text-[13px] font-bold text-white mb-2 block">효과</span>
                <div className="space-y-1">
                    {effects.map(effect => (
                        ...
                        >
                            ...
                            <span className={`text-[11px] ${selectedEffect === effect.id ? 'text-black/70' : 'text-[#666]'}`}>
            ...
            {results.length > 0 && (
                <div className="bg-[#252525] rounded-lg p-3">
                    <div className="flex justify-between items-center mb-2">
                        <span className="text-[13px] font-bold text-white">결과</span>
                            ...
                            <div key={result.id} className="bg-[#2c2c2c] rounded p-2">
                                ...
                                {result.status === 'loading' && (
                                    <div className="flex items-center gap-2">
                                        <svg className="w-3 h-3 animate-spin text-[#888]" fill="none" viewBox="0 0 24 24">
                                            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
                                            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" />
                                        </svg>
                                        <span className="text-[10px] text-[#888]">{result.processingStep}</span>
                                    </div>
                                )}
