    ...
    >
      ...
      >
        ...
        <div className="text-center mb-4 flex-shrink-0">
          <h2 className="text-2xl font-extrabold text-zinc-800">디버그 보기</h2>
        </div>
        
        <div className="flex flex-col gap-4 overflow-y-auto">
          <div>
            <p className="text-zinc-600 mb-2">AI에 전송된 이미지입니다. 빨간색 마커는 배치 위치를 나타냅니다.</p>
            <div className="rounded-lg overflow-hidden bg-zinc-100">
                <img src={imageUrl} alt="디버그용 마커가 표시된 배경 이미지" className="w-full h-full object-contain" />
            </div>
          </div>
          
          {prompt && (
            <div>
                <h3 className="text-lg font-bold text-zinc-800 mb-2">이미지 모델에 전송된 최종 프롬프트</h3>
